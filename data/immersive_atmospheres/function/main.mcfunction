...
execute as @a run function immersive_atmospheres:particles/toggle_particles_by_name
execute as @a if score @s ia_disable_all matches 1.. run function immersive_atmospheres:particles/disable_all_particles
execute as @a if score @s ia_enable_all matches 1.. run function immersive_atmospheres:particles/enable_all_particles
